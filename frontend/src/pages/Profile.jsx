...
const Profile = () => {
    ...
    if (!user) {
        return (
            <div className="pt-28 min-h-screen bg-[#f5f5f7] flex flex-col items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                    <h2 className="text-3xl font-black text-zinc-900 uppercase tracking-tighter mb-8">Authorization Required</h2>
        ...
        <div className='pt-28 pb-32 min-h-screen bg-[#f5f5f7] relative overflow-hidden'>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
                <div className="flex flex-col md:flex-row items-center justify-between mb-16 gap-8">
                    <div>
                        <h1 className="text-5xl font-black text-zinc-900 tracking-tighter uppercase leading-none">Internal Workspace</h1>
                        <p className="text-blue-500 text-xs font-black uppercase tracking-[0.4em] mt-3 italic">Authorized Personnel Only</p>
                    </div>
                    
                    <div className="bg-white p-1 rounded-2xl border border-zinc-200 flex items-center gap-2 shadow-sm">
                        ...
                        <span className="text-zinc-900 text-[10px] font-black uppercase tracking-[0.2em] px-3 pr-6">System Online</span>
                    </div>
                </div>

                <Tabs defaultValue="profile" className='w-full'>
                    <div className="flex justify-center mb-16">
                        <TabsList className="bg-white border border-zinc-200 p-1 rounded-2xl shadow-sm">
                            <TabsTrigger 
                                value="profile" 
                    ...
                    <TabsContent value="orders" className="mt-0 focus-visible:outline-none focus-visible:ring-0">
                        <div className="bg-white p-20 rounded-[40px] border border-zinc-200 text-center animate-in fade-in slide-in-from-bottom-8 duration-700 shadow-sm relative overflow-hidden group">
                           <div className="absolute inset-0 bg-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="w-24 h-24 bg-blue-50/50 rounded-[32px] flex items-center justify-center mx-auto mb-10 border border-blue-100 shadow-sm">
                                <ShoppingBag size={40} className="text-blue-500 drop-shadow-sm" />
                            </div>
                            <h3 className="text-3xl font-black text-zinc-900 mb-4 uppercase tracking-tighter italic">Log Archive Null</h3>
