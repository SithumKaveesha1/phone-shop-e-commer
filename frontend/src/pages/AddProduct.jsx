...
import { Package, DollarSign, Image as ImageIcon, Tag, Briefcase, Plus, ArrowLeft, Info, Loader2, Upload, Rocket, ShieldCheck, Cpu, Smartphone, Laptop, Tablet, Watch, Headphones } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                    <div>
                        ...
                        <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 mb-2">Add New Product</h1>
                        <p className="text-gray-500 text-sm">Fill in the details below to create a new product catalog entry.</p>
                    </div>
                    ...
                    <div className="xl:col-span-1 space-y-8">
                        ...
                        <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <span className="text-[10px] font-bold tracking-wider bg-gray-100 text-gray-600 px-2.5 py-1 rounded-full uppercase">{imageFiles.length}/5</span>
                            </div>
