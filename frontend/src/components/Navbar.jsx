        ...
        <header className='bg-black sticky top-0 w-full z-[100] border-b border-white/5'>
            ...
            <div className='max-w-[1500px] mx-auto flex justify-between items-center py-6 px-4 md:px-12 relative'>
                ...
                <div className='flex-1 flex items-center justify-end gap-6 md:gap-8'>
                    ...
                    <Link to="/cart" className='relative p-3 text-zinc-400 hover:text-blue-500 transition-all group overflow-visible pt-4'>
                         <ShoppingCart size={22} strokeWidth={2.5} className='group-hover:scale-110 transition-all duration-500 group-hover:drop-shadow-[0_0_10px_rgba(59,130,246,0.3)]' />
                         {cartItems.length > 0 && (
                        ...
                        <div className="flex items-center gap-6 md:gap-8 ml-4 pl-8 border-l border-white/10">
                            ...
                            {user?.role === 'admin' && (
                                <Link 
                                    ...
                                    className="w-11 h-11 rounded-2xl bg-zinc-100 flex items-center justify-center border border-zinc-200 text-zinc-400 hover:text-blue-500 hover:border-blue-500/50 hover:bg-blue-50 transition-all shadow-sm"
